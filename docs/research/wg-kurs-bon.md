...
| Число для снимка в `.env` | 2 (`WG_GOLD_PER_BOND`): та же договорённость, что у Lesta (ADR-0001), не публичный обмен |
...
| Источник снимка Оценки | Та же договорённость, что Курс бон Lesta: 1 бон = 2 золота (ADR-0001, ADR-0002) |
...
| Боны на счету WG-аккаунта в Оценке | Имущество: Курс бон 1 бон = 2 золота |
